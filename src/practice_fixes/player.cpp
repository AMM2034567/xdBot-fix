...
PlayerData PlayerPracticeFixes::saveData(PlayerObject* player) {
    ...
    // data.m_maybeRotatedObjectsMap... // removed in 2.2081
    ...
    // data.m_currentSlope3 = player->m_currentSlope3; // removed in 2.2081
    ...
    // data.m_flashRelated = player->m_flashRelated; // removed in 2.2081
    // data.m_flashRelated1 = player->m_flashRelated1; // removed in 2.2081
    ...
    // data.m_gv0096 = player->m_gv0096; // removed in 2.2081
    // data.m_gv0100 = player->m_gv0100; // removed in 2.2081
    ...
    // data.m_unk9e8 = player->m_unk9e8; // removed in 2.2081
    ...
    // data.m_ringOrStreakRelated = player->m_ringOrStreakRelated; // removed in 2.2081
    ...
    // data.m_unkAAC = player->m_unkAAC; // removed in 2.2081
    data.m_unkAngle1 = player->m_unkAngle1;
    data.m_yVelocityRelated3 = player->m_yVelocityRelated3;
    // data.m_gamevar0060 = player->m_gamevar0060; // removed in 2.2081
    data.m_swapColors = player->m_swapColors;
    // data.m_gamevar0062 = player->m_gamevar0062; // removed in 2.2081
    ...
    // data.m_robotHasRun3 = player->m_robotHasRun3; // removed in 2.2081
    // data.m_robotHasRun2 = player->m_robotHasRun2; // removed in 2.2081
    // data.m_item20 = player->m_item20; // removed in 2.2081
...
void PlayerPracticeFixes::applyData(PlayerObject* player, PlayerData data, bool isPlayer2, bool isFakePlayer) {
    ...
    // player->m_maybeRotatedObjectsMap... // removed in 2.2081
    ...
    // player->m_currentSlope3 = data.m_currentSlope3; // removed in 2.2081
    ...
    // player->m_unk9e8 = data.m_unk9e8; // removed in 2.2081
    ...
    // player->m_ringOrStreakRelated = data.m_ringOrStreakRelated; // removed in 2.2081
    ...
    // player->m_unkAAC = data.m_unkAAC; // removed in 2.2081
    player->m_unkAngle1 = data.m_unkAngle1;
    player->m_yVelocityRelated3 = data.m_yVelocityRelated3;
    // player->m_gamevar0060 = data.m_gamevar0060; // removed in 2.2081
    player->m_swapColors = data.m_swapColors;
    // player->m_gamevar0062 = data.m_gamevar0062; // removed in 2.2081
    ...
    // player->m_robotHasRun3 = data.m_robotHasRun3; // removed in 2.2081
    // player->m_robotHasRun2 = data.m_robotHasRun2; // removed in 2.2081
    // player->m_item20 = data.m_item20; // removed in 2.2081
